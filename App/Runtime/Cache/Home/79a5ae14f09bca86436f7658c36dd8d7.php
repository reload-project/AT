...
<div id="wrapper">
    <nav class="navbar navbar-default top-navbar" role="navigation">
        ...
        <ul class="nav navbar-top-links navbar-right">
            ...
            <li><a class="dropdown-button waves-effect waves-dark" href="#!" data-activates="dropdown1"><i class="fa fa-user fa-fw"></i> <b><?php echo ($_SESSION['admin']['nickname']); ?></b> <i class="material-icons right">arrow_drop_down</i></a></li>
        </ul>
    </nav>
    <!-- Dropdown Structure -->
    ...
    <nav class="navbar-default navbar-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
                ...
                <li>
                    <a href="<?php echo U('User/index');?>" class=" <?php if(CONTROLLER_NAME == 'User'): ?>active-menu<?php endif; ?>  waves-effect waves-dark"><i class="fa fa-desktop"></i> 用户管理</a>
                </li>
                <li>
                    <a href="<?php echo U('Index/index');?>" class=" <?php if(CONTROLLER_NAME == ''): ?>active-menu<?php endif; ?> waves-effect waves-dark"><i class="fa fa-bar-chart-o"></i> 测试栏</a>
                </li>
                 <!--                   <li>
                                ...
                                <form class="col s12">
                                    <div class="row">
                                        <div class="input-field col s6">
                                            姓名:<input id="username" type="text" class="validate">
                                            <!--<label for="username">姓名</label>-->
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="input-field col s6">
                                            昵称:<input id="nickname" type="text" class="validate">
                                            <!--<label for="nickname">昵称</label>-->
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="input-field col s6">
                                            密码:<input id="password" type="password" class="validate">
                                            <!--<label for="password">密码</label>-->
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="input-field col s6">
                                            手机号:<input id="phone" type="text" class="validate">
    ...
    <script type="text/javascript">
        function addMaster() {
            ...
            $.post("<?php echo U('Master/add_master');?>",{username:username,nickname:nickname,password:password,phone:phone},function(res) {
                if(res.err==1) {

                    location.href="<?php echo U('Master/index');?>";
                }
            });
        }
    </script>
