    ...
    <nav class="navbar-default navbar-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
                <li>
                    <a class="" href="javascript:"><i class="fa fa-dashboard"></i>Page & AT </a>
                </li>
                <li>
                    <a class="active-menu waves-effect waves-dark" href="<?php echo U('Master/index');?>"><i class="fa fa-dashboard"></i> 管理员</a>
                </li>
                <li>
                    <?php echo ($con); ?><a href="<?php echo U('User/index');?>" class="active-menu waves-effect waves-dark"><i class="fa fa-desktop"></i> 用户管理</a>
                </li>
                <!--					<li>
