                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-action">
                                员工列表
                                <a  href="<?php echo U('User/addUser');?>" style="margin-left: 10px;">
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        <tbody>
                                            <?php if(is_array($data)): foreach($data as $key=>$v): ?><tr class="odd gradeX">
                                                    <td><?php echo ($v['id']); ?></td>
                                                    <td width="60px;" ><?php echo ($v['name']); ?></td>
                                                    <td><?php echo ($v['nickname']); ?></td>
                                                    <td><?php echo ($v['gender']); ?></td>
                                                    <td><?php echo ($v['national']); ?></td>
                                                    <td width="60px;" ><?php echo ($v['depart']); ?></td>
                                                    <td width="90px;" ><?php echo ($v['position']); ?></td>
                                                    <td><?php echo ($v['relation']); ?></td>
                                                    <td><?php echo ($v['level_id']); ?></td>
                                                    <td><?php echo ($v['phone']); ?></td>
                                                    <td><?php echo ($v['email']); ?></td>
                                                    <td width="168px;" ><?php echo ($v['address']); ?></td>
                                                    <td><?php echo ($v['school']); ?></td>
                                                    <td><img src="<?php echo ($v['pic']); ?>" width="150px;" /></td>
                                                    <td><?php echo ($v['status']); ?></td>
                                                    <td><?php echo ($v['add_time']); ?></td>
                                                    <!--<td><?php echo ($v['update_time']); ?></td>-->
                                                    <td>
                                                        <div class="btn " role="group" aria-label="..." >
                                                            <a  href='<?php echo U("User/editUser?id=$v[id]" );?>' style="color: #0D47A1;">编辑</a>
                                                        </div>
                                                        <div class="btn " role="group" aria-label="..." onclick='delUser("<?php echo ($v[id]); ?>")'>
                                                            <a  href="javascript:" style="color: #843534;">删除</a>
                                                        </div>
                                                        <div class="btn " role="group" aria-label="..." onclick='statusUser("<?php echo ($v[id]); ?>","<?php echo ($v[status]); ?>")'>
    ...
    <script type="text/javascript">
        ...
        function delUser(id) {
            layer.confirm('是否删除该用户？', {
                ...
                $.post('<?php echo U("User/delUser");?>',{id:id},function(res) {
                    if(res.err==1) {
                        location=location;
                    } else {
        ...
        function statusUser(id,status) {
            layer.confirm('是否更改状态？', {
                ...
                $.post('<?php echo U("User/userStatus");?>',{id:id,status:status},function(res) {
                    if(res.err==1) {
                        location=location;
                    } else {
