...
<div id="wrapper">
                            ...
                            <form class="col s12">
                                <div class="row">
                                    <div class="input-field col s6">
                                        规则名称:<input id="rules" type="text" class="validate" value="<?php echo ($info["rules"]); ?>" />
                                        <!--<label for="username">姓名</label>-->
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="input-field col s6">
                                        规则地址:<input id="url" type="text" class="validate" value="<?php echo ($info["url"]); ?>" />
                                        <!--<label for="username">姓名</label>-->
                                        <small>PS:地址例子:(Index/index);</small>
                                    </div>
                                </div>
                                <div class="btn " role="group" aria-label="..." onclick="editRules()">
                                    提交
    ...
    <script type="text/javascript">
        function editRules() {
            ...
            var url = $("#url").val();
            if(!rules) {
                layer.msg("规则名称不能为空");return;
            }
            $.post("<?php echo U('Rules/editRules');?>",{id:id,rules:rules,url:url},function(res) {
                if(res.err==1) {

                    location.href="<?php echo U('Rules/index');?>";
                }
            });
        }
    </script>
