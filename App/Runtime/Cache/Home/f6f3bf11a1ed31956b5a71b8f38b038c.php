                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-action">
                                管理员列表
                                <a  href="<?php echo U('Master/addMaster');?>"  style="margin-left: 10px;">
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        <tbody>
                                            <?php if(is_array($data)): foreach($data as $key=>$v): ?><tr class="odd gradeX">
                                                    ...
                                                    <td>
                                                        <div class="btn " role="group" aria-label="..." >
                                                            <a  href='<?php echo U("Master/editMaster?id=$v[id]" );?>' style="color: #0D47A1;">编辑</a>
                                                        </div>
                                                        <div class="btn " role="group" aria-label="..." onclick='delMaster("<?php echo ($v[id]); ?>")'>
    ...
    <script type="text/javascript">
        ...
        function delMaster(id) {
            layer.confirm('是否删除该管理员？', {
                ...
                $.post('<?php echo U("Master/del_master");?>',{id:id},function(res) {
                    if(res.err==1) {
                        location=location;
                    } else {
