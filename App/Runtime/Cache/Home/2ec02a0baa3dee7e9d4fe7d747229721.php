                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-action">
                                规则列表
                                <a  href="<?php echo U('Rules/addRules');?>"  style="margin-left: 10px;">
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        <tbody>
                                            <?php if(is_array($data)): foreach($data as $key=>$v): ?><tr class="odd gradeX">
                                                    ...
                                                    <td>
                                                        <div class="btn " role="group" aria-label="..." >
                                                            <a  href='<?php echo U("Rules/editRules?id=$v[id]" );?>' style="color: #0D47A1;">编辑</a>
                                                        </div>
                                                        <div class="btn " role="group" aria-label="..." onclick='delRules("<?php echo ($v[id]); ?>")'>
...
<!--    <script src="/App/Home/Common/assets/js/dataTables/jquery.dataTables.js"></script>
    ...
    <script type="text/javascript">
        ...
        function delRules(id) {
            layer.confirm('是否删除该规则？', {
                btn: ['确定','取消'] //按钮
            }, function(){
                $.post('<?php echo U("Rules/delRules");?>',{id:id},function(res) {
                    if(res.err==1) {
                        location=location;
                    } else {
