...
<!--                <?php if((in_array('User',$rr))): ?><li>
                                ...
                                <form class="col s12">
                                    <div class="row">
                                        <div class="input-field col s6">
                                            规则名称:<input id="rules" type="text" class="validate" />
                                            <!--<label for="username">姓名</label>-->
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="input-field col s6">
                                            规则地址:<input id="url" type="text" class="validate" />
                                            <!--<label for="username">姓名</label>-->
                                            <small>PS:地址例子:(Index/index);</small>
                                        </div>
                                    </div>
                                    <div class="btn " role="group" aria-label="..." onclick="addRules()">
                                        提交
    ...
    <script type="text/javascript">
        function addRules() {
            ...
            $.post("<?php echo U('Rules/addRules');?>",{rules:rules,url:url},function(res) {
                if(res.err==1) {
